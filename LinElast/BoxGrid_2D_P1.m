...
BoundaryNodes(1).Nodes = [1:(nelemx+1)/2];  % The first boundary (bottom left half)
BoundaryNodes(5).Nodes = [(nelemx+1)/2+1:nelemx+1];  % The fifth boundary (bottom right half)
% Code Changes form HW12 Problem 1 ****************************************
...
%     BoundaryElems(1).SurfaceIndicator = -2*ones(nelemx,1);
    ...
    % Code Changes form HW12 Problem 1 ****************************************
    BoundaryElems(1).Elems = [1:(nelemx+1)/2];  % The first boundary (bottom left half)
    BoundaryElems(1).SurfaceIndicator = -2*ones((nelemx+1)/2,1);
    
    BoundaryElems(5).Elems = [(nelemx+1)/2+1:nelemx+1];  % The fifth boundary (bottom right half)
    BoundaryElems(5).SurfaceIndicator = -2*ones((nelemx+1)/2,1);
    % Code Changes form HW12 Problem 1 ****************************************
