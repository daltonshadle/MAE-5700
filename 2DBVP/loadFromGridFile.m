...
%
function [Nodes,Elems,BoundaryStruct]=loadFromGridFile(prefix )
% include_variables;
% load header file
...
[BoundaryElems] = GenElmSurfaceIndicator(surfaceIndicator,nel,nen,ElementType,BoundaryElems,BoundaryNodes,Elems);
...
Elems = Elems';
% -----------------------------------------------------    
function [BoundaryElems] = GenElmSurfaceIndicator(surfaceIndicator,nel,nen,ElementType,BoundaryElems,BoundaryNodes,Elems)
% include_variables;
    ...
    for i = 1 : nen
        ...
        for k = 1:n
            ...
            for j = 2:3
                ...
                A = Elems(a,e);
                if ( ~IsBoundaryNode(A, indicator,BoundaryNodes))
                    allInd = 0;
                    break;
                end
            end
...
function OnBoundary = IsBoundaryNode(glbNodeID, indicator,BoundaryNodes)
% include_variables;
