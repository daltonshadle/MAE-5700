...
% Assemble global stiffness matrix K and global force vector F for the BEAM
% code. This function makes use of the MATLAB command SPARSE which takes as
% input three vectors and assembles a sparse matrix from the information
% contained. 
...
% global force vector
for e=1:numEls
    [ke,fe] = BeamElem(e,meshStruct); % make the local stiffness matrix 
