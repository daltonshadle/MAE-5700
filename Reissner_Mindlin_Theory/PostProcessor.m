...
if(plotStress)
    ...
    patchPlot(stress(:,4), meshStruct, '\sigma_{xz} (Pa)', [loadStr, 'sigma_xz_', meshStr]);
    patchPlot(stress(:,5), meshStruct, '\sigma_{yz} (Pa)', [loadStr, 'sigma_yz_', meshStr]);
...
if(plotStrain)
    ...
    patchPlot(strain(:,4), meshStruct, '\epsilon_{xz}', [loadStr, 'epsilon_xz_', meshStr]);
    patchPlot(strain(:,5), meshStruct, '\epsilon_{yz}', [loadStr, 'epsilon_yz_', meshStr]);
end
