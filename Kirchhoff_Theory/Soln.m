% *************************************************************************
% Name: Soln.m
% Notes: globalSystem = Soln(globalSystem,boundStruct)
%     Apply the essential boundary conditions and solve the global system 
%     for the nodal degrees of freedom for LinElast. 
