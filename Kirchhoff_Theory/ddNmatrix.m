% *************************************************************************
% Name: ddNmatrix.m
% Notes: ddN=Nmatrix(QP)
%     This returns the matrix of the 2nd derivatives of shape functions ddN 
...
% Calculate the 2nd derivatives of the shape functions with respect to xi and
% eta.
...
% derivatives placed together, ddN (3x12 matrix)
